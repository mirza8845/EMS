    ...
    return (
      <View style={{ flex: 1 }}>
        ...
        <View style={{ height: 60, backgroundColor: '#5B2ED4', justifyContent: 'center', paddingLeft: 20 }}>
          <Text style={{ color: 'white', fontWeight: '700', fontSize: 16 }}>Activity</Text>
        </View>
  
        {/* Employee List */}
        <ScrollView style={{ backgroundColor: 'white', padding: 10 }}>
          <Text style={{ fontWeight: '700', fontSize: 16, paddingVertical: 10 }}>Activity List</Text>
          ...
          {usersList.map((item, index) => (
            <View key={index} style={{ backgroundColor: '#fff', borderRadius: 10, padding: 20, marginBottom: 20, elevation: 6 }}>
              ...
              <Text style={{ fontSize: 18, fontWeight: '700', marginBottom: 10 }}>{'Role: ' + 'Employee'}</Text>
              <Text style={{ fontSize: 18, fontWeight: '700', marginBottom: 10 }}>{'Status: ' + 'Working'}</Text>
